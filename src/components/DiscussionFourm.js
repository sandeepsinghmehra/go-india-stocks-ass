...
export default function DiscussionFourm(){
    return (
        <div id={"discussion-fourm"} className='pl-2 lg:pl-10 pr-2 lg:pr-5 h-full'>
          ...
          <div className='bg-white relative mt-0 lg:mt-1 flex w-full h-18 justify-evenly py-2 lg:py-5 px-1 lg:px-4 rounded-lg shadow-lg'>
          ...
          <div className='discussion-section-height mt-4 overflow-auto'>
            <div className='bg-white flex flex-col my-3 rounded-lg shadow-lg py-2 lg:py-5 px-4 lg:px-10'>
              <div className="relative mx-auto w-fit h-fit flex place-items-center rounded-lg">
                <Image
                  className="relative object-fill w-full h-44 rounded-lg"
              ...
              <div className='flex justify-evenly my-3 '>
                      ...
                      <div className='flex flex-col w-4/5'>
                        ...
                        <div className='flex'>
                          <div>
                            ...
                            <span className='inline-flex place-items-center w-fit h-6 lg:h-8 px-1 lg:px-2 py-1 bg-red-700 text-[10px] lg:text-xs text-white border border-solid rounded-full'>Sector 1</span>
                            <div>
                              ...
                              <div className='flex justify-evenly w-full'>
                                <div className='flex flex-row items-center'>
                                  <FaHeart color='red' className='w-5 lg:w-6 h-6 lg:h-6' />
                    ...
                    <div className='bg-white flex justify-start my-3 rounded-lg shadow-lg py-2 lg:py-5 px-4 lg:px-10'>
                      <div className='w-[10%]'>
                        <FcBusinessman size={40} className='w-7 lg:w-10 h-7 lg:h-10 bg-red-950 rounded-full' />
                      </div>
                    ...
                    <div className='bg-white flex justify-start my-3 rounded-lg shadow-lg py-2 lg:py-5 px-4 lg:px-10'>
                      <div className='w-[10%]'>
                        <FcBusinesswoman size={40} className='w-7 lg:w-10 h-7 lg:h-10 bg-red-950 rounded-full' />
                      </div>
                      <div className='flex w-4/5'>
                          <div>
                            <span className='pr-3 lg:pr-5'><strong>Lorum Ipsum</strong></span> 
